...
class OrbitModel(Model):
    ...
    def __init__(self, axis: int = 0):
        ...
        self.second_cnn_layer = OrbitConvolution(name="orbit", kernel_size=3, num_filters=1024, axis=axis)
    ...
    def build(self, input_shape):
        self.first_cnn_layer = Conv2D(name="convolution", filters=1024, kernel_size=(3, 3), activation='relu',
